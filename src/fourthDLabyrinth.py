...
class fourthDLabyrinth(object):
    def __init__(self, N, start):
        self.N = N
        self.graph = Graph(pow(N, 4))
        self.start = start
        self.coordinates = []
                            ...
                            if z == 0:
                                ...
                                if y == 0:
                                    ...
                                    if x == 0:
                                        ...
                                        m.addEdge(s, s + pow(self.N, 3))
                                        m.addEdge(s, s - pow(self.N, 3))
                        self.coordinates[s].setCoordinates(x, self.N - 1 - y, z, w)
                        s += 1
        return m
    ...
    def printPath(self, path, e):
        ...
        for x in range(len(edges) - 1, 1, -1):
            ...
            z = [c1.Z(), c2.Z()]
            w = [c1.W(), c2.W()]
            ax.plot(x, y, z, w, "red", linewidth=3.0)
        plt.show()
